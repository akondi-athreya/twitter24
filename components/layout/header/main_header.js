...
export default function Header6({ scroll, isMobileMenu, handleMobileMenu, isCartSidebar, handleCartSidebar, onLoginPage }) {
    ...
    return (
        <>
                                        ...
                                        <ul>
                                            ...
                                            {/* <li className="has-dropdown has-megamenu">
                                                ...
                                                <ul className="submenu mega-menu">
                                                    <li>
                                                        <a className="mega-menu-title">Products</a>
                                                        <ul>
                                                            <li><Link href="/products">Products</Link></li>
            ...
            <HeaderSticky scroll={scroll} isCartSidebar={isCartSidebar} handleCartSidebar={handleCartSidebar} onLoginPage={onLoginPage}/>
            <HeaderTabSticky scroll={scroll} isMobileMenu={isMobileMenu} handleMobileMenu={handleMobileMenu} isCartSidebar={isCartSidebar} handleCartSidebar={handleCartSidebar} onLoginPage={onLoginPage}/>
            <HeaderMobSticky scroll={scroll} isMobileMenu={isMobileMenu} handleMobileMenu={handleMobileMenu} isCartSidebar={isCartSidebar} handleCartSidebar={handleCartSidebar} onLoginPage={onLoginPage}/>
        </>
    )
}
