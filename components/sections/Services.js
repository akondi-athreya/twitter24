                ...
                <div className="container">
                    <div className="row services-gx-item">
                        <div className="col-lg-3 col-sm-6">
                            <div className="tpservicesitem d-flex align-items-center mb-30">
                                <div className="tpservicesitem__icon mr-20">
                                    <img src="/assets/img/svg/services01.svg" alt="" className="fn__svg" />
                                </div>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="tpservicesitem d-flex align-items-center mb-30">
                                <div className="tpservicesitem__icon mr-20">
                                    <img src="/assets/img/svg/services02.svg" alt="" className="fn__svg" />
                                </div>
                                <div className="tpservicesitem__content">
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="tpservicesitem d-flex align-items-center mb-30">
                                <div className="tpservicesitem__icon mr-20">
                                    <img src="/assets/img/svg/services03.svg" alt="" className="fn__svg" />
                                </div>
                                <div className="tpservicesitem__content">
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="tpservicesitem d-flex align-items-center mb-30">
                                <div className="tpservicesitem__icon mr-20">
                                    <img src="/assets/img/svg/services04.svg" alt="" className="fn__svg" />
                                </div>
                                <div className="tpservicesitem__content">
