...
import Header6 from "./header/main_header"

export default function Layout({ headerStyle, footerStyle, headTitle, breadcrumbTitle, children , onLoginPage}) {
    ...
    return (
        <>
            ...
            {headerStyle == 6 ? <Header6 scroll={scroll} isMobileMenu={isMobileMenu} handleMobileMenu={handleMobileMenu} isCartSidebar={isCartSidebar} handleCartSidebar={handleCartSidebar} onLoginPage={onLoginPage}/> : null}
